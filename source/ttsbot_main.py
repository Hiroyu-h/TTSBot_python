...
# ----------------------------------------- #
# ◆変更履歴◆
# 絵文字が含まれていると文章呼んでくれない ⇒　◆対応済 errors='ignore'で対応
# ＿(　_´ω`)_ﾍﾟｼｮ　「おめが ぺしょ」って読み上げる ⇒　◆対応済 ギリシャ文字はエスケープする
# チャット同時だと読み上げない ⇒ ◆対応済 発言中の場合waitさせる処理を挟んだ
# ｗｗをダブリュダブリュって呼んでしまう ⇒　文末の全角ｗは「わら」と読ませる
# メンション読ませると壊れたみたいに読み上げる ⇒ ◆対応済
# メンションでニックネームを呼ばせる　⇒　◆対応済
# ロールメンションの読み ⇒　◆対応済
# config.ini から値を読み取って起動させる ⇒　◆対応済
# config.ini の上書き
# config.ini にrep_gの有効無効
# 発言途中のストップ def stp
# ----------------------------------------- #
global version
global voice_num
